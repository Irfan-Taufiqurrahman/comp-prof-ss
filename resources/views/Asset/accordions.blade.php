<div class="pb-14">
    <section class="w-full bg-white border divide-y rounded shadow-sm px-8 md:px-56">
        <details class="p-4 group" open>
            <summary class="[&::-webkit-details-marker]:hidden relative flex gap-4 pr-8 font-medium list-none cursor-pointer text-slate-700 focus-visible:outline-none transition-colors duration-300 group-hover:text-slate-900">
                ...
                Berapa Biaya Ongkos Kirim Ekpedisi Samudera Suri?
            ...
            <p class="mt-4 text-slate-500">
                Untuk tarif pengiriman pada Samudera Suri sangat bervariasi sesuai dengan jarak pengiriman dan berat barang yang akan dikirim. Silahkan hubungi nomor pada kontak kami agar kami bisa menindaklanjuti keinginan Anda
            </p>
        </details>
        ...
        <details class="p-4 group" open>
            <summary class="[&::-webkit-details-marker]:hidden relative flex gap-4 pr-8 font-medium list-none cursor-pointer text-slate-700 focus-visible:outline-none transition-colors duration-300 group-hover:text-slate-900">
                ...
                Apakah Barang yang Saya kirim Dijamin Aman?
                <svg xmlns="http://www.w3.org/2000/svg" class="absolute right-0 w-4 h-4 transition duration-300 top-1 stroke-slate-700 shrink-0 group-open:rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-labelledby="title-ac06 desc-ac06">
                    <title id="title-ac06">Open icon</title>
                    <desc id="desc-ac06">icon that represents the state of the summary</desc>
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
            ...
            <p class="mt-4 text-slate-500">
                Barang customer kami akan kami jamin keamanannya beserta terdapat layanan asuransi guna menambah tingkat keamanannya, dan sekaligus penanda bahwa kami sangat prefesional dalam bidang jasa pengiriman.
            </p>
        </details>
