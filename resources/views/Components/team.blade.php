<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
            <p class="inline-block px-3 py-px mb-4 text-lg font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
            </p>
        </div>
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span class="relative inline-block">
                ...
                <span class="relative">Para Prefesional</span>
            </span>
            yang Ahli Pada Bidangnya
        </h2>
        <p class="text-base text-gray-700 md:text-lg">
            Jasa Kami telah didukung oleh pekerja yang teliti dan bertanggungjawab serta dengan sepenuh hati memenuhi permintaan pengiriman agar dapat disiapkan, diantar hingga tempat tujuan dengan aman.
        </p>
    </div>
